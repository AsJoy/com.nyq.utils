 ...
 */
var EventUtil = {
    "addHandler": function(element, handlerChild ,handlerName, handler){
    ...
    "removeHandler" :function(element, handlerName, handler){
